...
const TableCarPart = () => {
  ...
  const fetchDatacar = async () => {
    try {
      const apiUrl = "https://35.175.230.48/cardata";
  ...
  const fetchDatapart = async () => {
    try {
      const apiUrl = "https://35.175.230.48/carpart";
      const queryParams = {
        brand: requestbrand,
        name: requestname,
        year: requestyear,
  ...
  const handleUpload = async () => {
    ...
    await axios
      .post(`https://35.175.230.48/jsonfileaddcarpart`, formData)
      .then((response) => {
  ...
  const Addsubmit = async () => {
    const apiUrl = "https://35.175.230.48/addpart";
    const requestData = {
  ...
  const Editsubmit = async () => {
    ...
    const apiUrl = "https://35.175.230.48/editpart";
    const requestData = {
      newid: editid,
      oldid: old_editid,
      type: typesend,
  ...
  const handleDelete = async (record) => {
    ...
    // ส่งข้อมูลการลบ
    const apiUrl = "https://35.175.230.48/deletepart";
    const requestData = {
      delid: id,
      type: typesend,
      name: namesave,
