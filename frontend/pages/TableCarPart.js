...
const TableCarPart = () => {
  ...
  const fetchDatacar = async () => {
    try {
      const apiUrl = "https://54.173.229.99/cardata";
  ...
  const fetchDatapart = async () => {
    try {
      const apiUrl = "https://54.173.229.99/carpart";
      const queryParams = {
        brand: requestbrand,
        name: requestname,
        year: requestyear,
  ...
  const handleUpload = async () => {
    ...
    await axios
      .post(`https://54.173.229.99/jsonfileaddcarpart`, formData)
      .then((response) => {
  ...
  const Addsubmit = async () => {
    const apiUrl = "https://54.173.229.99/addpart";
    const requestData = {
  ...
  const Editsubmit = async () => {
    ...
    const apiUrl = "https://54.173.229.99/editpart";
    const requestData = {
      newid: editid,
      oldid: old_editid,
      type: typesend,
  ...
  const handleDelete = async (record) => {
    ...
    // ส่งข้อมูลการลบ
    const apiUrl = "https://54.173.229.99/deletepart";
    const requestData = {
      delid: id,
      type: typesend,
      name: namesave,
