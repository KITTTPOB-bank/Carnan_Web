...
const Tablepart = () => {
  ...
  const handleUpload = async () => {
    ...
    await axios
      .post(`https://3.81.234.197/jsonfile?typecheck=${typesend}`, formData)
      .then((response) => {
  ...
  const fetchDatapart = async () => {
    try {
      const apiUrl = "https://3.81.234.197/carpartall";
  ...
  const handleDelete = async (id) => {
    const apiUrl = "https://3.81.234.197/deleteallpart";
    const requestData = {
      delid: id,
      type: typesend,
    };
  ...
  const AddNewData = async () => {
    const apiUrl = "https://3.81.234.197/addallpart";
    const requestData = {
      name: name_new,
      code: code_new,
      price: price_new,
  ...
  const Editpartdata = async () => {
    ...
    const apiUrl = "https://3.81.234.197/editallpart";
    const requestData = {
      name: name_edit,
      code: code_edit,
      price: price_edit,
