...
const Tablepart = () => {
  ...
  const handleUpload = async () => {
    ...
    await axios
      .post(`http://34.235.119.235/jsonfile?typecheck=${typesend}`, formData)
      .then((response) => {
  ...
  const fetchDatapart = async () => {
    try {
      const apiUrl = "http://34.235.119.235/carpartall";
  ...
  const handleDelete = async (id) => {
    const apiUrl = "http://34.235.119.235/deleteallpart";
    const requestData = {
      delid: id,
      type: typesend,
    };
  ...
  const AddNewData = async () => {
    const apiUrl = "http://34.235.119.235/addallpart";
    const requestData = {
      name: name_new,
      code: code_new,
      price: price_new,
  ...
  const Editpartdata = async () => {
    ...
    const apiUrl = "http://34.235.119.235/editallpart";
    const requestData = {
      name: name_edit,
      code: code_edit,
      price: price_edit,
